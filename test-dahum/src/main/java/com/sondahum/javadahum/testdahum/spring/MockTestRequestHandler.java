...
abstract class MockTestRequestHandler extends AbstractTestHelper {
    ...
    static <K, V> MultiValueMap<String, String> generateParams(Map<String, String> parameters) {
        Map<String, Map<String, List<String>>> multiValueMap = new LinkedMultiValueMap<K, V>();
